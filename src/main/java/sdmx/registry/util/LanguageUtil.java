...
public class LanguageUtil {
    ...
    public static sdmx.registry.entities.Language EN = new sdmx.registry.entities.Language();

    public static sdmx.registry.entities.Language FR = new sdmx.registry.entities.Language();
